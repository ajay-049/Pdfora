...
export default function PDFToJPG() {
  ...
  useEffect(() => {
    // SEO Meta tags
    document.title = 'PDF to JPG Converter - Free Online Tool | PDFora';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Convert PDF to JPG images online for free. High-quality PDF to JPG conversion with custom settings. Extract all pages as JPG images. No signup required.');
    }
    ...
    const structuredData = {
      ...
      "url": "https://pdfora.com/pdf-to-jpg",
      "description": "Free online PDF to JPG converter tool",
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setStep(3);
      toast.success(`Successfully converted ${images.length} pages to JPG`);
    } catch (error) {
  ...
  const handleDownloadAll = () => {
    ...
    downloadZip(convertedImages, `${file?.name?.replace('.pdf', '') || 'converted'}-jpg-images.zip`);
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <h1 className="text-3xl font-bold mb-4 text-gray-900">PDF to JPG</h1>
              <p className="text-gray-600 mb-8">Extract pages from your PDF and convert them into high-quality JPG images.</p>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-6">
                      Your PDF will be converted to high-quality JPG images. Each page will become a separate JPG file.
                    </p>
                    <Button
                      onClick={() => setStep(1)}
                      variant="secondary"
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm h-fit">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-800">JPG format with optimized compression for photos and images</p>
                  </div>
                </div>
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="text-center bg-white rounded-xl shadow-sm p-6">
                ...
                <p className="text-gray-600 mb-6">
                  Successfully converted {convertedImages.length} pages to JPG images
                </p>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-sm p-8">
          <h2 className="text-2xl font-bold mb-6">Why Choose Our PDF to JPG Converter?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Convert PDF pages to high-resolution JPG images with customizable quality settings</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">📦</span>
              ...
              <p className="text-gray-600 text-sm">Download all converted images as a convenient ZIP file or individually</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">🔒</span>
